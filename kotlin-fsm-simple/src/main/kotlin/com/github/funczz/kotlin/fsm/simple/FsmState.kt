...
open class FsmState<T : Any> : IFsmState<T> {
     ...
     * value: 遷移情報
     */
    private val permitEvents: HashMap<Class<*>, Transition<T>> = HashMap()

    /**
     * 無視するイベントを登録する
     * element: イベントの Class
     */
    private val ignoreEvents: HashSet<Class<*>> = HashSet()
     ...
     */
    private val actions: MutableMap<Action, ((event: Any, context: T) -> Unit)?> = mutableMapOf()
